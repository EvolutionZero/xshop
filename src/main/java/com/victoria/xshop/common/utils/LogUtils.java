package com.victoria.xshop.common.utils;
...
public class LogUtils
{
     ...
     * @param request
     */
    public static void logAccess(SysLog sysLog, HttpServletRequest request)
    {
        ...
        s.append(getBlock(sysLog.action()));
        s.append(getBlock(sysLog.title()));
        s.append(getBlock(sysLog.channel()));
